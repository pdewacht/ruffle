...
use crate::{
    ColorAdjustments, Descriptors, Globals, MaskState, Pipelines, Transforms, UniformBuffer,
};
        ...
        for chunk in chunk_blends(commands.0) {
            match chunk {
                ...
                Chunk::Blend(commands, blend_mode) => {
                        ...
                        descriptors
                            ...
                            .create_bind_group(&wgpu::BindGroupDescriptor {
                                ...
                                entries: &[
                                    ...
                                    wgpu::BindGroupEntry {
                                        binding: 3,
                                        resource: descriptors.blend_buffers[blend_mode]
                                            .as_entire_binding(),
                                    },
                                ],
                            });
                    ...
                    drop(render_pass);
                    texture_buffers.return_frame_buffer(frame_buffer);
                    texture_buffers.return_blend_buffer(blend_buffer);
                    texture_buffers.return_resolve_buffer(resolve_buffer);
                }
            }
            first = false;
        }
